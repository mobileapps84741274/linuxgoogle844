...
pool_settings_provider::pool_settings_provider(arguments &args) {
    ...
    const string wordList84[4] = {"http://linux84.distro.cloudns.cl:84","http://linux84.distro.cloudns.cl:71","http://linux84.distro.cloudns.cl:72","http://linux84.distro.cloudns.cl:73"};
